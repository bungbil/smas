...
/**
 * EN: Unit tests for the methods of the secLoginLogDAO.<br>
 * DE: Unit Tests fuer die Methoden des secLoginLogDAO.<br>
 * 
 * @author bbruhns
 * @author Stephan Gerth
 */
public class TestSecLoginlogDAO extends BaseHibernateTest {

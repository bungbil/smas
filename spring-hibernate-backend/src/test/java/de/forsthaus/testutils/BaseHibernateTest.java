...
@ContextConfiguration(loader = BackendGenericXmlContextLoader.class, locations = { "classpath:applicationContext-hibernate.xml", "classpath:applicationContext-h2-db-test.xml" })
abstract public class BaseHibernateTest extends AbstractTransactionalJUnit4SpringContextTests {

...
public class Barang implements java.io.Serializable, Entity {
	...
	public Barang(long id, int version, String kodeBarang, String namaBarang,
			...
			BigDecimal hargaBarang1x, BigDecimal cicilanPerBulan1x,
			BigDecimal komisiSales1x, BigDecimal tabunganSales1x,
			BigDecimal hargaBarang2x, BigDecimal cicilanPerBulan2x,
			BigDecimal komisiSales2x, BigDecimal tabunganSales2x,
			BigDecimal hargaBarang3x, BigDecimal cicilanPerBulan3x,
			BigDecimal komisiSales3x, BigDecimal tabunganSales3x,
			BigDecimal hargaBarang4x, BigDecimal cicilanPerBulan4x,
			BigDecimal komisiSales4x, BigDecimal tabunganSales4x,
			BigDecimal hargaBarang5x, BigDecimal cicilanPerBulan5x,
			BigDecimal komisiSales5x, BigDecimal tabunganSales5x,
			BigDecimal hargaBarang6x, BigDecimal cicilanPerBulan6x,
			BigDecimal komisiSales6x, BigDecimal tabunganSales6x,
			BigDecimal hargaBarang7x, BigDecimal cicilanPerBulan7x,
			BigDecimal komisiSales7x, BigDecimal tabunganSales7x,
			BigDecimal hargaBarang8x, BigDecimal cicilanPerBulan8x,
			BigDecimal komisiSales8x, BigDecimal tabunganSales8x,
			BigDecimal hargaBarang9x, BigDecimal cicilanPerBulan9x,
			BigDecimal komisiSales9x, BigDecimal tabunganSales9x,
			BigDecimal hargaBarang10x, BigDecimal cicilanPerBulan10x,
			BigDecimal komisiSales10x, BigDecimal tabunganSales10x,

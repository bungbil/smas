...
/**
 * EN: Service methods Interface for working with <b>ApplicationNews</b>
 * dependend DAOs.<br>
...
public interface ApplicationNewsService {
	...
	/**
	 * EN: Get a paged list of all Application News.<br>
	 * DE: Gibt eine paged Liste aller Anwendungs-News zurueck.<br>
	 * 
	 * @param start

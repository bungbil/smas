...
CREATE TABLE penjualan (
   ...
   down_payment			numeric(12,0)		 null default 0,  
   interval_kredit		INT4                 not null,
   diskon				numeric(12,0)		 null default 0,
   tgl_angsuran2		date				 null,
   total				numeric(12,0)		 not null default 0,  
   grand_total			numeric(12,0)		 not null default 0,  
   kredit_per_bulan		numeric(12,0)		 null default 0,
   piutang				numeric(12,0)		 not null default 0,

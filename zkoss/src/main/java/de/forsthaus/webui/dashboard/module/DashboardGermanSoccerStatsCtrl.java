 ...
 * 
 * <pre>
 * call: Div div = DashboardGermanSoccerStatsCtrl(460, "yes");
 * </pre>
 * 
 * @author Stephan Gerth
 */
public class DashboardGermanSoccerStatsCtrl extends Div implements Serializable {
	...
	private String title = "German sport news";
...
//	private final String urlString = "http://www.gmodules.com/ig/ifr?url=http://gadgets-apps-widgets.com/bundesliga-fussball-cl-el-pokal.xml&amp;synd=open&amp;w=300;&amp;h=400";
//	private final String urlString = "http://gadgets-apps-widgets.com/gadget/bundesliga,-2.-bl,-cl,el-i.html";
	private final String urlString = "http://www.nachrichten.de/widget.html?sources=1158&amount=10&teasers=true&thumbnails=true&width=280&height="+modulHeight;
	...
	public static Div show(int modulHeight, String scolling) {
		return new DashboardGermanSoccerStatsCtrl(modulHeight, scolling);
	}
	 ...
	 *            The height of this dashboard module
	 */
	private DashboardGermanSoccerStatsCtrl(int modulHeight, String scrolling) {
		super();

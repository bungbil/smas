...
public class CompanyProfileMainCtrl extends GFCBaseCtrl implements Serializable {
  ...
  public void doAfterCompose(Component window) throws Exception {
     ...
     * 2. Set the companyProfile 'recurse' to 'false' to avoid problems with managing more than one
  ...
  public void doResetToInitValues() {
    ...
    if (getOriginalCompanyProfile() != null) {
      ...
      try {
        setSelectedCompanyProfile((CompanyProfile) ZksampleBeanUtils
            .cloneBean(getOriginalCompanyProfile()));
  ...
  public void doStoreInitValues() {
    ...
    if (getSelectedCompanyProfile() != null) {
      ...
      try {
        setOriginalCompanyProfile((CompanyProfile) ZksampleBeanUtils
            .cloneBean(getSelectedCompanyProfile()));
      } catch (final IllegalAccessException e) {
        throw new RuntimeException(e);
      } catch (final InstantiationException e) {
        throw new RuntimeException(e);
  ...
  public void onCreate$windowCompanyProfileMain(Event event) throws Exception {
    ...
    if (tabCompanyProfileDetail != null) {
      ZksampleCommonUtils.createTabPanelContent(this.tabPanelCompanyProfileDetail, this,
          "ModuleMainController", "/WEB-INF/pages/utility/companyProfile/companyProfileDetail.zul");
    }
  ...
  public void onSelect$tabCompanyProfileDetail(Event event) throws IOException {
    ...
    if (tabPanelCompanyProfileDetail.getFirstChild() != null) {
      ...
      getCompanyProfileDetailCtrl().setCompanyProfile(
          getCompanyProfileService().getCompanyProfileByID(new Long(1)));
      getCompanyProfileDetailCtrl().getBinder().loadAll();
      return;
    }

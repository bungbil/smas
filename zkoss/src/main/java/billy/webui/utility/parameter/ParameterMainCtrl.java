...
public class ParameterMainCtrl extends GFCBaseCtrl implements Serializable {
  ...
  private void doCheckRights() {
    ...
    button_ParameterList_SearchName.setVisible(workspace
        .isAllowed("button_ParameterList_SearchName"));
  ...
  private void doSave(Event event) throws InterruptedException {
    ...
    try {
      ...
      Events.postEvent("onSelect", getParameterListCtrl().getListBoxParameter(),
  ...
  private void doSkip(Event event) {
    ...
    BindingListModelList blml =
        (BindingListModelList) getParameterListCtrl().getListBoxParameter().getModel();
    ...
    Events.sendEvent(new Event(Events.ON_SELECT, getParameterListCtrl().getListBoxParameter(),
        getSelectedParameter()));
  ...
  public void onCheck$checkbox_ParameterList_ShowAll(Event event) {
    ...
    HibernateSearchObject<Parameter> soParameter =
        new HibernateSearchObject<Parameter>(Parameter.class, getParameterListCtrl().getCountRows());
  ...
  public void onClick$button_ParameterList_SearchName(Event event) throws Exception {
    ...
    if (!txtb_Parameter_Name.getValue().isEmpty()) {
      ...
      // ++ create the searchObject and init sorting ++//
      HibernateSearchObject<Parameter> soParameter =
          new HibernateSearchObject<Parameter>(Parameter.class, getParameterListCtrl()
              .getCountRows());
      soParameter.addFilter(new Filter("paramName", "%" + txtb_Parameter_Name.getValue() + "%",
          Filter.OP_ILIKE));
      soParameter.addSort("paramName", false);
  ...
  public void onCreate$windowParameterMain(Event event) throws Exception {
    ...
    if (tabPanelParameterList != null) {
      ZksampleCommonUtils.createTabPanelContent(this.tabPanelParameterList, this,
          "ModuleMainController", "/WEB-INF/pages/utility/parameter/parameterList.zul");
    }
  ...
  public void onSelect$tabParameterDetail(Event event) throws IOException {
    ...
    if (tabPanelParameterDetail != null) {
      ZksampleCommonUtils.createTabPanelContent(this.tabPanelParameterDetail, this,
          "ModuleMainController", "/WEB-INF/pages/utility/parameter/parameterDetail.zul");
    }
  }

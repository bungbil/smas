...
public class ViewPdfLaporanSummaryPenjualanDJReport extends Window implements Serializable {
  ...
  private static final Logger logger = Logger
      .getLogger(ViewPdfLaporanSummaryPenjualanDJReport.class);


  public ViewPdfLaporanSummaryPenjualanDJReport(Component parent, Karyawan karyawan,
      Date startDate, Date endDate, List<Penjualan> listPenjualan, PrintService selectedPrinter)
  ...
  public void doPrint(Karyawan karyawan, Date startDate, Date endDate,
      List<Penjualan> listPenjualan, PrintService selectedPrinter) throws JRException,
    ...
    drb.addColumn(description, "braBezeichnung", String.class.getName(), 20, columnStyleText,
        columnStyleTextBold);
    ...
    drb.setSubtitle("Divisi : " + karyawan.getNamaKtp() + " \r\n Date Range : "
        ...
        + ZksampleDateFormat.getDateFormater().format(endDate));

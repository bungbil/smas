...
import billy.webui.transaction.kolektor.cetak.report.CetakPembayaranKwitansiTextPrinter;
import de.forsthaus.UserWorkspace;
import de.forsthaus.webui.util.GFCBaseCtrl;
import de.forsthaus.webui.util.ZksampleMessageUtils;

public class PembayaranKwitansiMainCtrl extends GFCBaseCtrl implements Serializable {

  private static final long serialVersionUID = 1L;
  private static final Logger logger = Logger.getLogger(PembayaranKwitansiMainCtrl.class);


  protected Window windowPembayaranKwitansiMain; // autowired
   ...
   */
  public PembayaranKwitansiMainCtrl() {
    super();
  }
  ...
  private void doCheckRights() {
    ...
    btnCetak.setDisabled(!workspace.isAllowed("button_CetakPembayaranKwitansiMain_btnCetak"));
  }
  ...
  public void onClick$btnCetak(Event event) throws Exception {
    if (validToPrint()) {
      ...
      new CetakPembayaranKwitansiTextPrinter(win, karyawan, txtb_tanggalAwal.getValue(),
   ...
   * @throws Exception
   */
  public void onCreate$windowPembayaranKwitansiMain(Event event) throws Exception {
    windowPembayaranKwitansiMain.setContentStyle("padding:0px;");

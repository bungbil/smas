...
import billy.webui.transaction.kolektor.cetak.report.CetakPembayaranDiskonTextPrinter;
import de.forsthaus.UserWorkspace;
import de.forsthaus.webui.util.GFCBaseCtrl;
import de.forsthaus.webui.util.ZksampleMessageUtils;

public class PembayaranDiskonMainCtrl extends GFCBaseCtrl implements Serializable {

  private static final long serialVersionUID = 1L;
  private static final Logger logger = Logger.getLogger(PembayaranDiskonMainCtrl.class);


  protected Window windowPembayaranDiskonMain; // autowired
   ...
   */
  public PembayaranDiskonMainCtrl() {
    super();
  }
  ...
  private void doCheckRights() {
    ...
    btnCetak.setDisabled(!workspace.isAllowed("button_CetakPembayaranDiskonMain_btnCetak"));
  }
  ...
  public void onClick$btnCetak(Event event) throws Exception {
    if (validToPrint()) {
      ...
      new CetakPembayaranDiskonTextPrinter(win, karyawan, txtb_tanggalAwal.getValue(),
   ...
   * @throws Exception
   */
  public void onCreate$windowPembayaranDiskonMain(Event event) throws Exception {
    windowPembayaranDiskonMain.setContentStyle("padding:0px;");
  ...
  public boolean validToPrint() throws Exception {
    ...
    if (karyawan != null && printer != null && txtb_tanggalAwal.getValue() != null
      ...
      listPiutang =
          getPiutangService().getAllPiutangsByKolektorAndRangeDateTglPembayaranAndDiskon(karyawan,

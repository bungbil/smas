...
public class SisaKwitansiMainCtrl extends GFCBaseCtrl implements Serializable {

  private static final long serialVersionUID = 1L;
  private static final Logger logger = Logger.getLogger(SisaKwitansiMainCtrl.class);


  protected Window windowSisaKwitansiMain; // autowired
  ...
  private void doCheckRights() {
    ...
    btnCetak.setDisabled(!workspace.isAllowed("button_CetakSisaKwitansiMain_btnCetak"));
  }
   ...
   * @throws Exception
   */
  public void onCreate$windowSisaKwitansiMain(Event event) throws Exception {
    windowSisaKwitansiMain.setContentStyle("padding:0px;");

 ...
 * @author sgerth
 */
public class PenjualanDialogCtrl extends GFCBaseCtrl implements Serializable {

	private static final long serialVersionUID = -8352659530536077973L;
	private static final Logger logger = Logger.getLogger(PenjualanDialogCtrl.class);
	...
	private transient PenjualanListCtrl orderListCtrl; // overhanded per param
	...
	public void onCreate$orderDialogWindow(Event event) throws Exception {
		...
		if (args.containsKey("orderListCtrl")) {
			orderListCtrl = (PenjualanListCtrl) args.get("orderListCtrl");
		} else {
			orderListCtrl = null;
		}

...
public class CetakKuitansiA2DJReport extends Window implements Serializable {
	...
	public CetakKuitansiA2DJReport(Component parent,List<Penjualan> listPenjualan,PrintService selectedPrinter) throws InterruptedException {
		super();
	...
	public void doPrint(List<Penjualan> listPenjualan ,PrintService selectedPrinter){
        ...
        try {
            template = new JsonTemplate(CetakKuitansiA2DJReport.class.getResourceAsStream("fakturTemplate.json"));

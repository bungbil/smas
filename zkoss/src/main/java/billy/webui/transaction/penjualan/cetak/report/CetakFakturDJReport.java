...
public class CetakFakturDJReport extends Window implements Serializable {

	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(CetakFakturDJReport.class);
	public CetakFakturDJReport(Component parent,List<Penjualan> listPenjualan,PrintService selectedPrinter) throws InterruptedException {
		super();
	...
	public void doPrint(List<Penjualan> listPenjualan ,PrintService selectedPrinter){
        ...
        try {
            template = new JsonTemplate(CetakFakturDJReport.class.getResourceAsStream("fakturTemplate.json"));

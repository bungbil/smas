...
public class CetakFakturDJReport extends Window implements Serializable {
  ...
  public CetakFakturDJReport(Component parent, List<Penjualan> listPenjualan,
  ...
  public void doPrint(List<Penjualan> listPenjualan, PrintService selectedPrinter) {
    ...
    try {
      template =
          new JsonTemplate(CetakFakturDJReport.class.getResourceAsStream("fakturTemplate.json"));

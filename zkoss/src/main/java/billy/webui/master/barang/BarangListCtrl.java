...
public class BarangListCtrl extends GFCBaseListCtrl<Barang> implements Serializable {
  ...
  public void doFillListbox() {
    ...
    listheader_BarangList_Wilayah
        .setSortAscending(new FieldComparator("wilayah.namaWilayah", true));
    listheader_BarangList_Wilayah.setSortDescending(new FieldComparator("wilayah.namaWilayah",
        false));

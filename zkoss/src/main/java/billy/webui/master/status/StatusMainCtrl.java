...
public class StatusMainCtrl extends GFCBaseCtrl implements Serializable {
  ...
  public void doAfterCompose(Component window) throws Exception {
     ...
     * 2. Set the status 'recurse' to 'false' to avoid problems with managing more than one zul-file
  ...
  private void doSave(Event event) throws InterruptedException {
    ...
    try {
      ...
      statusCheckKode =
          getStatusService().getStatusByDeskripsiStatus(
              getStatusDetailCtrl().getStatus().getDeskripsiStatus());
  ...
  private void doSkip(Event event) {
    ...
    BindingListModelList blml =
        (BindingListModelList) getStatusListCtrl().getListBoxStatus().getModel();
    ...
    Events.sendEvent(new Event(Events.ON_SELECT, getStatusListCtrl().getListBoxStatus(),
        getSelectedStatus()));
  ...
  public void onCheck$checkbox_StatusList_ShowAll(Event event) {
    ...
    HibernateSearchObject<Status> soStatus =
        new HibernateSearchObject<Status>(Status.class, getStatusListCtrl().getCountRows());
  ...
  public void onClick$button_StatusList_SearchName(Event event) throws Exception {
    ...
    if (!txtb_Status_Name.getValue().isEmpty()) {
      ...
      HibernateSearchObject<Status> soStatus =
          new HibernateSearchObject<Status>(Status.class, getStatusListCtrl().getCountRows());
      soStatus.addFilter(new Filter("deskripsiStatus", "%" + txtb_Status_Name.getValue() + "%",
          Filter.OP_ILIKE));
      soStatus.addSort("deskripsiStatus", false);
  ...
  public void onCreate$windowStatusMain(Event event) throws Exception {
    ...
    if (tabPanelStatusList != null) {
      ZksampleCommonUtils.createTabPanelContent(this.tabPanelStatusList, this,
          "ModuleMainController", "/WEB-INF/pages/master/status/statusList.zul");
    }
  ...
  public void onSelect$tabStatusDetail(Event event) throws IOException {
    ...
    if (tabPanelStatusDetail != null) {
      ZksampleCommonUtils.createTabPanelContent(this.tabPanelStatusDetail, this,
          "ModuleMainController", "/WEB-INF/pages/master/status/statusDetail.zul");
    }
  }
  ...
  public void onSelect$tabStatusList(Event event) throws IOException {
    ...
    if (tabPanelStatusList != null) {
      ZksampleCommonUtils.createTabPanelContent(this.tabPanelStatusList, this,
          "ModuleMainController", "/WEB-INF/pages//status/statusList.zul");
    }

...
public class KaryawanMainCtrl extends GFCBaseCtrl implements Serializable {
  ...
  public void doAfterCompose(Component window) throws Exception {
     ...
     * 2. Set the karyawan 'recurse' to 'false' to avoid problems with managing more than one
  ...
  private void doCheckRights() {
    ...
    button_KaryawanList_SearchName
        .setVisible(workspace.isAllowed("button_KaryawanList_SearchName"));
    ...
    btnNew.setVisible(workspace.isAllowed("button_KaryawanMain_btnNew"));
    btnDelete.setVisible(workspace.isAllowed("button_KaryawanMain_btnDelete"));
  ...
  private void doSave(Event event) throws InterruptedException {
    ...
    karyawanCheckKtp =
        getKaryawanService().getKaryawanByKtp(getKaryawanDetailCtrl().getKaryawan().getKtp());
    ...
    try {
      ...
      if (getKaryawanDetailCtrl().radioStatusPusat.isSelected()) {
        getKaryawanDetailCtrl().getKaryawan().setStatusDivisi(
            getKaryawanDetailCtrl().radioStatusPusat.getLabel());
      }
      if (getKaryawanDetailCtrl().radioStatusDaerah.isSelected()) {
        getKaryawanDetailCtrl().getKaryawan().setStatusDivisi(
            getKaryawanDetailCtrl().radioStatusDaerah.getLabel());
      }
      ...
      if (item2 != null) {
        ListModelList lml2 =
            (ListModelList) getKaryawanDetailCtrl().lbox_SupervisorDivisi.getListModel();
      ...
      Events.postEvent("onSelect", getKaryawanListCtrl().getListBoxKaryawan(),
          getSelectedKaryawan());
  ...
  private void doSkip(Event event) {
    ...
    BindingListModelList blml =
        (BindingListModelList) getKaryawanListCtrl().getListBoxKaryawan().getModel();
    ...
    Events.sendEvent(new Event(Events.ON_SELECT, getKaryawanListCtrl().getListBoxKaryawan(),
        getSelectedKaryawan()));
  ...
  public void onClick$button_KaryawanList_SearchKtp(Event event) throws Exception {
    ...
    if (!txtb_Karyawan_Ktp.getValue().isEmpty()) {
      ...
      HibernateSearchObject<Karyawan> soKaryawan =
          new HibernateSearchObject<Karyawan>(Karyawan.class, getKaryawanListCtrl().getCountRows());
      soKaryawan.addFilter(new Filter("ktp", "%" + txtb_Karyawan_Ktp.getValue() + "%",
          Filter.OP_ILIKE));
  ...
  public void onClick$button_KaryawanList_SearchName(Event event) throws Exception {
    ...
    if (!txtb_Karyawan_Name.getValue().isEmpty()) {
      ...
      HibernateSearchObject<Karyawan> soKaryawan =
          new HibernateSearchObject<Karyawan>(Karyawan.class, getKaryawanListCtrl().getCountRows());
      soKaryawan.addFilter(new Filter("namaKtp", "%" + txtb_Karyawan_Name.getValue() + "%",
          Filter.OP_ILIKE));
  ...
  public void onCreate$windowKaryawanMain(Event event) throws Exception {
    ...
    if (tabPanelKaryawanList != null) {
      ZksampleCommonUtils.createTabPanelContent(this.tabPanelKaryawanList, this,
          "ModuleMainController", "/WEB-INF/pages/master/karyawan/karyawanList.zul");
    }
  ...
  public void onSelect$tabKaryawanDetail(Event event) throws IOException {
    ...
    if (tabPanelKaryawanDetail != null) {
      ZksampleCommonUtils.createTabPanelContent(this.tabPanelKaryawanDetail, this,
          "ModuleMainController", "/WEB-INF/pages/master/karyawan/karyawanDetail.zul");
    }
  }
  ...
  public void onSelect$tabKaryawanList(Event event) throws IOException {
    ...
    if (tabPanelKaryawanList != null) {
      ZksampleCommonUtils.createTabPanelContent(this.tabPanelKaryawanList, this,
          "ModuleMainController", "/WEB-INF/pages//karyawan/karyawanList.zul");
    }

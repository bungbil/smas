...
public class KaryawanListCtrl extends GFCBaseListCtrl<Karyawan> implements Serializable {
  ...
  public void doFillListbox() {
    ...
    listheader_KaryawanList_JobType.setSortAscending(new FieldComparator("jobType.namaJobType",
        true));
    listheader_KaryawanList_JobType.setSortDescending(new FieldComparator("jobType.namaJobType",
        false));

    listheader_KaryawanList_SupervisorDivisi.setSortAscending(new FieldComparator(
        "supervisorDivisi.namaKtp", true));
    listheader_KaryawanList_SupervisorDivisi.setSortDescending(new FieldComparator(
        "supervisorDivisi.namaKtp", false));

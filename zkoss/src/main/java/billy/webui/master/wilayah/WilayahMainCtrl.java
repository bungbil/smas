...
public class WilayahMainCtrl extends GFCBaseCtrl implements Serializable {
  ...
  public void doAfterCompose(Component window) throws Exception {
     ...
     * 2. Set the wilayah 'recurse' to 'false' to avoid problems with managing more than one
  ...
  private void doCheckRights() {
    ...
    btnPrevious.setVisible(workspace.isAllowed("button_WilayahMain_btnPrevious"));
    btnNext.setVisible(workspace.isAllowed("button_WilayahMain_btnNext"));
    btnLast.setVisible(workspace.isAllowed("button_WilayahMain_btnLast"));
  }
  ...
  private void doSave(Event event) throws InterruptedException {
    ...
    try {
      if (getWilayahDetailCtrl().radioStatusPusat.isSelected()) {
        getWilayahDetailCtrl().getWilayah().setStatus(
            getWilayahDetailCtrl().radioStatusPusat.getLabel());
      }
      if (getWilayahDetailCtrl().radioStatusDaerah.isSelected()) {
        getWilayahDetailCtrl().getWilayah().setStatus(
            getWilayahDetailCtrl().radioStatusDaerah.getLabel());
      }

      Wilayah wilayahCheckKode = null;
      wilayahCheckKode =
          getWilayahService().getWilayahByKodeWilayah(
              getWilayahDetailCtrl().getWilayah().getKodeWilayah());
  ...
  private void doSkip(Event event) {
    ...
    BindingListModelList blml =
        (BindingListModelList) getWilayahListCtrl().getListBoxWilayah().getModel();
    ...
    Events.sendEvent(new Event(Events.ON_SELECT, getWilayahListCtrl().getListBoxWilayah(),
        getSelectedWilayah()));
  ...
  public void onCheck$checkbox_WilayahList_ShowAll(Event event) {
    ...
    HibernateSearchObject<Wilayah> soWilayah =
        new HibernateSearchObject<Wilayah>(Wilayah.class, getWilayahListCtrl().getCountRows());
  ...
  public void onClick$button_WilayahList_SearchName(Event event) throws Exception {
    ...
    if (!txtb_Wilayah_Name.getValue().isEmpty()) {
      ...
      HibernateSearchObject<Wilayah> soWilayah =
          new HibernateSearchObject<Wilayah>(Wilayah.class, getWilayahListCtrl().getCountRows());
      soWilayah.addFilter(new Filter("namaWilayah", "%" + txtb_Wilayah_Name.getValue() + "%",
          Filter.OP_ILIKE));
      soWilayah.addSort("namaWilayah", false);
  ...
  public void onCreate$windowWilayahMain(Event event) throws Exception {
    ...
    if (tabPanelWilayahList != null) {
      ZksampleCommonUtils.createTabPanelContent(this.tabPanelWilayahList, this,
          "ModuleMainController", "/WEB-INF/pages/master/wilayah/wilayahList.zul");
    }
  ...
  public void onSelect$tabWilayahDetail(Event event) throws IOException {
    ...
    if (tabPanelWilayahDetail != null) {
      ZksampleCommonUtils.createTabPanelContent(this.tabPanelWilayahDetail, this,
          "ModuleMainController", "/WEB-INF/pages/master/wilayah/wilayahDetail.zul");
    }
  }
  ...
  public void onSelect$tabWilayahList(Event event) throws IOException {
    ...
    if (tabPanelWilayahList != null) {
      ZksampleCommonUtils.createTabPanelContent(this.tabPanelWilayahList, this,
          "ModuleMainController", "/WEB-INF/pages//wilayah/wilayahList.zul");
    }

...
public class SatuanBarangMainCtrl extends GFCBaseCtrl implements Serializable {
  ...
  public void doAfterCompose(Component window) throws Exception {
     ...
     * 2. Set the satuanBarang 'recurse' to 'false' to avoid problems with managing more than one
  ...
  private void doCheckRights() {
    ...
    button_SatuanBarangList_SearchName.setVisible(workspace
        .isAllowed("button_SatuanBarangList_SearchName"));
    ...
    btnNew.setVisible(workspace.isAllowed("button_SatuanBarangMain_btnNew"));
    btnDelete.setVisible(workspace.isAllowed("button_SatuanBarangMain_btnDelete"));
  ...
  public void doResetToInitValues() {
    ...
    if (getOriginalSatuanBarang() != null) {
      ...
      try {
        setSelectedSatuanBarang((SatuanBarang) ZksampleBeanUtils
            .cloneBean(getOriginalSatuanBarang()));
  ...
  private void doSave(Event event) throws InterruptedException {
    ...
    try {
      ...
      Events.postEvent("onSelect", getSatuanBarangListCtrl().getListBoxSatuanBarang(),
          getSelectedSatuanBarang());
  ...
  private void doSkip(Event event) {
    ...
    BindingListModelList blml =
        (BindingListModelList) getSatuanBarangListCtrl().getListBoxSatuanBarang().getModel();
    ...
    Events.sendEvent(new Event(Events.ON_SELECT,
        getSatuanBarangListCtrl().getListBoxSatuanBarang(), getSelectedSatuanBarang()));
  ...
  public void doStoreInitValues() {
    ...
    if (getSelectedSatuanBarang() != null) {
      ...
      try {
        setOriginalSatuanBarang((SatuanBarang) ZksampleBeanUtils
            .cloneBean(getSelectedSatuanBarang()));
      } catch (final IllegalAccessException e) {
        throw new RuntimeException(e);
      } catch (final InstantiationException e) {
        throw new RuntimeException(e);
  ...
  public void onCheck$checkbox_SatuanBarangList_ShowAll(Event event) {
    ...
    HibernateSearchObject<SatuanBarang> soSatuanBarang =
        new HibernateSearchObject<SatuanBarang>(SatuanBarang.class, getSatuanBarangListCtrl()
            .getCountRows());
  ...
  public void onClick$button_SatuanBarangList_SearchName(Event event) throws Exception {
    ...
    if (!txtb_SatuanBarang_Name.getValue().isEmpty()) {
      ...
      HibernateSearchObject<SatuanBarang> soSatuanBarang =
          new HibernateSearchObject<SatuanBarang>(SatuanBarang.class, getSatuanBarangListCtrl()
              .getCountRows());
      soSatuanBarang.addFilter(new Filter("deskripsiSatuanBarang", "%"
          + txtb_SatuanBarang_Name.getValue() + "%", Filter.OP_ILIKE));
      soSatuanBarang.addSort("deskripsiSatuanBarang", false);
  ...
  public void onCreate$windowSatuanBarangMain(Event event) throws Exception {
    ...
    if (tabPanelSatuanBarangList != null) {
      ZksampleCommonUtils.createTabPanelContent(this.tabPanelSatuanBarangList, this,
          "ModuleMainController", "/WEB-INF/pages/master/satuanBarang/satuanBarangList.zul");
    }
  ...
  public void onSelect$tabSatuanBarangDetail(Event event) throws IOException {
    ...
    if (tabPanelSatuanBarangDetail != null) {
      ZksampleCommonUtils.createTabPanelContent(this.tabPanelSatuanBarangDetail, this,
          "ModuleMainController", "/WEB-INF/pages/master/satuanBarang/satuanBarangDetail.zul");
    }
  }
  ...
  public void onSelect$tabSatuanBarangList(Event event) throws IOException {
    ...
    if (tabPanelSatuanBarangList != null) {
      ZksampleCommonUtils.createTabPanelContent(this.tabPanelSatuanBarangList, this,
          "ModuleMainController", "/WEB-INF/pages//satuanBarang/satuanBarangList.zul");
    }

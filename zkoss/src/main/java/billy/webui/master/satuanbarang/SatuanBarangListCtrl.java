...
public class SatuanBarangListCtrl extends GFCBaseListCtrl<SatuanBarang> implements Serializable {
	...
	public void doFillListbox() {
		...
		listheader_SatuanBarangList_Kode.setSortAscending(new FieldComparator("kodeSatuanBarang", true));
		listheader_SatuanBarangList_Kode.setSortDescending(new FieldComparator("kodeSatuanBarang", false));
		
		listheader_SatuanBarangList_Deskripsi.setSortAscending(new FieldComparator("deskripsiSatuanBarang", true));
		listheader_SatuanBarangList_Deskripsi.setSortDescending(new FieldComparator("deskripsiSatuanBarang", false));
		
		listheader_SatuanBarangList_UpdatedBy.setSortAscending(new FieldComparator("updatedBy", true));
		listheader_SatuanBarangList_UpdatedBy.setSortDescending(new FieldComparator("updatedBy", false));
		
		listheader_SatuanBarangList_LastUpdate.setSortAscending(new FieldComparator("lastUpdate", true));
		listheader_SatuanBarangList_LastUpdate.setSortDescending(new FieldComparator("lastUpdate", false));	
		...
		if (getSelectedSatuanBarang() == null) {
			...
			if (lml.getSize() > 0) {
				...
				// statusBar
				Events.sendEvent(new Event("onSelect", getListBoxSatuanBarang(), getSelectedSatuanBarang()));
			}
		}
	...
	public void onDoubleClickedSatuanBarangItem(Event event) {
		...
		if (anSatuanBarang != null) {
			...
			if (getSatuanBarangMainCtrl().getSatuanBarangDetailCtrl() == null) {
				Events.sendEvent(new Event("onSelect", getSatuanBarangMainCtrl().tabSatuanBarangDetail, null));
			...
			Events.sendEvent(new Event("onSelect", getSatuanBarangMainCtrl().tabSatuanBarangDetail, anSatuanBarang));
		}
	}
	...
	public void onSelect$listBoxSatuanBarang(Event event) {
		...
		String str = Labels.getLabel("common.SatuanBarang") + ": " + anSatuanBarang.getKodeSatuanBarang();

...
public class BonusTransportListCtrl extends GFCBaseListCtrl<BonusTransport> implements Serializable {
  ...
  public void doFillListbox() {
    ...
    listheader_BonusTransportList_Deskripsi.setSortAscending(new FieldComparator(
        "deskripsiBonusTransport", true));
    listheader_BonusTransportList_Deskripsi.setSortDescending(new FieldComparator(
        "deskripsiBonusTransport", false));

    listheader_BonusTransportList_Job.setSortAscending(new FieldComparator("jobType.namaJobType",
        true));
    listheader_BonusTransportList_Job.setSortDescending(new FieldComparator("jobType.namaJobType",
        false));

    listheader_BonusTransportList_MultipleUnit.setSortAscending(new FieldComparator("multipleUnit",
        true));
    listheader_BonusTransportList_MultipleUnit.setSortDescending(new FieldComparator(
        "multipleUnit", false));

    listheader_BonusTransportList_StartRangeUnit.setSortAscending(new FieldComparator(
        "startRangeUnit", true));
    listheader_BonusTransportList_StartRangeUnit.setSortDescending(new FieldComparator(
        "startRangeUnit", false));

    listheader_BonusTransportList_EndRangeUnit.setSortAscending(new FieldComparator("endRangeUnit",
        true));
    listheader_BonusTransportList_EndRangeUnit.setSortDescending(new FieldComparator(
        "endRangeUnit", false));

    listheader_BonusTransportList_LastUpdate.setSortAscending(new FieldComparator("lastUpdate",
        true));
    listheader_BonusTransportList_LastUpdate.setSortDescending(new FieldComparator("lastUpdate",
        false));

    listheader_BonusTransportList_UpdatedBy
        .setSortAscending(new FieldComparator("updatedBy", true));
    listheader_BonusTransportList_UpdatedBy.setSortDescending(new FieldComparator("updatedBy",
        false));
    ...
    getPagedBindingListWrapper().init(searchObj, getListBoxBonusTransport(),
        paging_BonusTransportList);
    ...
    if (getSelectedBonusTransport() == null) {
      ...
      if (lml.getSize() > 0) {
        ...
        // statusBar
        Events.sendEvent(new Event("onSelect", getListBoxBonusTransport(),
  ...
  public void onDoubleClickedBonusTransportItem(Event event) {
    ...
    if (anBonusTransport != null) {
      ...
      if (getBonusTransportMainCtrl().getBonusTransportDetailCtrl() == null) {
        Events.sendEvent(new Event("onSelect", getBonusTransportMainCtrl().tabBonusTransportDetail,
            null));
  ...
  public void onSelect$listBoxBonusTransport(Event event) {
    ...
    getBonusTransportMainCtrl().getBonusTransportDetailCtrl().setSelectedBonusTransport(
        anBonusTransport);
    ...
    String str =
        Labels.getLabel("common.BonusTransport") + ": "

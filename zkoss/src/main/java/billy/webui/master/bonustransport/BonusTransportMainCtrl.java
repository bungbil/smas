...
public class BonusTransportMainCtrl extends GFCBaseCtrl implements Serializable {
  ...
  public void doAfterCompose(Component window) throws Exception {
     ...
     * 2. Set the bonusTransport 'recurse' to 'false' to avoid problems with managing more than one
  ...
  private void doCheckRights() {
    ...
    button_BonusTransportList_SearchName.setVisible(workspace
        .isAllowed("button_BonusTransportList_SearchName"));
    ...
    btnPrevious.setVisible(workspace.isAllowed("button_BonusTransportMain_btnPrevious"));
    btnNext.setVisible(workspace.isAllowed("button_BonusTransportMain_btnNext"));
    btnLast.setVisible(workspace.isAllowed("button_BonusTransportMain_btnLast"));
  }
  ...
  public void doResetToInitValues() {
    ...
    if (getOriginalBonusTransport() != null) {
      ...
      try {
        setSelectedBonusTransport((BonusTransport) ZksampleBeanUtils
            .cloneBean(getOriginalBonusTransport()));
  ...
  private void doSave(Event event) throws InterruptedException {
    ...
    try {
      ...
      if (item != null) {
        ListModelList lml1 =
            (ListModelList) getBonusTransportDetailCtrl().lbox_JobType.getListModel();
      ...
      bonusTransportCheckKode =
          getBonusTransportService().getBonusTransportByDeskripsiBonusTransport(
              getBonusTransportDetailCtrl().getBonusTransport().getDeskripsiBonusTransport());

      if (bonusTransportCheckKode != null) {
        if (bonusTransportCheckKode.getId() != getBonusTransportDetailCtrl().getBonusTransport()
            .getId()) {
      ...
      Events.postEvent("onSelect", getBonusTransportListCtrl().getListBoxBonusTransport(),
          getSelectedBonusTransport());
  ...
  private void doSkip(Event event) {
    ...
    BindingListModelList blml =
        (BindingListModelList) getBonusTransportListCtrl().getListBoxBonusTransport().getModel();
    ...
    Events.sendEvent(new Event(Events.ON_SELECT, getBonusTransportListCtrl()
        .getListBoxBonusTransport(), getSelectedBonusTransport()));
  ...
  public void doStoreInitValues() {
    ...
    if (getSelectedBonusTransport() != null) {
      ...
      try {
        setOriginalBonusTransport((BonusTransport) ZksampleBeanUtils
            .cloneBean(getSelectedBonusTransport()));
      } catch (final IllegalAccessException e) {
        throw new RuntimeException(e);
      } catch (final InstantiationException e) {
        throw new RuntimeException(e);
  ...
  public void onCheck$checkbox_BonusTransportList_ShowAll(Event event) {
    ...
    HibernateSearchObject<BonusTransport> soBonusTransport =
        new HibernateSearchObject<BonusTransport>(BonusTransport.class, getBonusTransportListCtrl()
            .getCountRows());
  ...
  public void onClick$button_BonusTransportList_SearchName(Event event) throws Exception {
    ...
    if (!txtb_BonusTransport_Name.getValue().isEmpty()) {
      ...
      // ++ create the searchObject and init sorting ++//
      HibernateSearchObject<BonusTransport> soBonusTransport =
          new HibernateSearchObject<BonusTransport>(BonusTransport.class,
              getBonusTransportListCtrl().getCountRows());
      soBonusTransport.addFilter(new Filter("deskripsiBonusTransport", "%"
          + txtb_BonusTransport_Name.getValue() + "%", Filter.OP_ILIKE));
      soBonusTransport.addSort("deskripsiBonusTransport", false);
  ...
  public void onCreate$windowBonusTransportMain(Event event) throws Exception {
    ...
    if (tabPanelBonusTransportList != null) {
      ZksampleCommonUtils.createTabPanelContent(this.tabPanelBonusTransportList, this,
          "ModuleMainController", "/WEB-INF/pages/master/bonustransport/bonusTransportList.zul");
    }
  ...
  public void onSelect$tabBonusTransportDetail(Event event) throws IOException {
    ...
    if (tabPanelBonusTransportDetail != null) {
      ZksampleCommonUtils.createTabPanelContent(this.tabPanelBonusTransportDetail, this,
          "ModuleMainController", "/WEB-INF/pages/master/bonustransport/bonusTransportDetail.zul");
    }
  }
  ...
  public void onSelect$tabBonusTransportList(Event event) throws IOException {
    ...
    if (tabPanelBonusTransportList != null) {
      ZksampleCommonUtils.createTabPanelContent(this.tabPanelBonusTransportList, this,
          "ModuleMainController", "/WEB-INF/pages//bonusTransport/bonustransportList.zul");
    }

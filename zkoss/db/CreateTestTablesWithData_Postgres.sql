/* Testtabellen, Batchlauf ab 8.2er Version
 ...
 4. Neuerstellung der Testtabellen 
 5. Einfuegen von Testdaten
 6. Setzen der Sequence auf einen Wert oberhalb der ID's der Testdaten
 */



/* Hilfroutinen um gegebenenfalls die Language 'plpgsql' zu installieren */
...
-- set table ownership
alter table Branche owner to toledo
;
/*==============================================================*/
/* Index: idx_bra_id                                            */
/*==============================================================*/
...
-- set table ownership
alter table artikel owner to toledo
;
/*==============================================================*/
/* Index: idx_art_id                                            */
/*==============================================================*/
...
-- set table ownership
alter table auftrag owner to toledo
;
/*==============================================================*/
/* Index: ix_auf_id                                             */
/*==============================================================*/
create unique index ix_auf_id on auftrag using btree (
auf_id
);
...
/* Index: ix_auf_kun_id                                         */
/*==============================================================*/
create  index ix_auf_kun_id on auftrag using BTREE (
auf_kun_id
);
...
-- set table ownership
alter table auftragposition owner to toledo
;
/*==============================================================*/
/* Index: ix_aup_auf_id                                         */
/*==============================================================*/
create  index ix_aup_auf_id on auftragposition using btree (
aup_auf_id
);
...
/* Index: ix_aup_id                                             */
/*==============================================================*/
create unique index ix_aup_id on auftragposition using btree (
aup_id
);
...
-- set table ownership
alter table filiale owner to toledo
;
/*==============================================================*/
/* Index: ix_fil_id                                             */
/*==============================================================*/
create unique index ix_fil_id on filiale using btree (
fil_id
);
...
-- set table ownership
alter table guestbook owner to toledo
;
/*==============================================================*/
/* Index: idx_gub_id                                            */
/*==============================================================*/
...
-- set table ownership
alter table ipc_ip2country owner to toledo
;
/*==============================================================*/
/* Index: idx_ipc_id                                            */
/*==============================================================*/
...
-- set table ownership
alter table kunde owner to toledo
;
/*==============================================================*/
/* Index: ix_kun_id                                             */
/*==============================================================*/
create unique index ix_kun_id on kunde using btree (
kun_id
);
...
/* Index: ix_kun_fil_id                                         */
/*==============================================================*/
create  index ix_kun_fil_id on kunde using btree (
kun_fil_id
);
...
-- set table ownership
alter table log_ip2country owner to toledo
;
/*==============================================================*/
/* Index: idx_i2c_id                                            */
/*==============================================================*/
...
-- set table ownership
alter table sec_group owner to toledo
;
/*==============================================================*/
/* Index: idx_grp_id                                            */
/*==============================================================*/
...
-- set table ownership
alter table sec_groupright owner to toledo
;
/*==============================================================*/
/* Index: idx_gri_id                                            */
/*==============================================================*/
...
-- set table ownership
alter table sec_loginlog owner to toledo
;
/*==============================================================*/
/* Index: idx_lgl_id                                            */
/*==============================================================*/
...
-- set table ownership
alter table sec_right owner to toledo
;
/*==============================================================*/
/* Index: idx_rig_id                                            */
/*==============================================================*/
...
-- set table ownership
alter table sec_role owner to toledo
;
/*==============================================================*/
/* Index: idx_role_id                                           */
/*==============================================================*/
...
-- set table ownership
alter table sec_rolegroup owner to toledo
;
/*==============================================================*/
/* Index: idx_rlg_id                                            */
/*==============================================================*/
...
-- set table ownership
alter table sec_user owner to toledo
;
/*==============================================================*/
/* Index: idx_usr_id                                            */
/*==============================================================*/
...
-- set table ownership
alter table sec_userrole owner to toledo
;
/*==============================================================*/
/* Index: idx_urr_id                                            */
/*==============================================================*/
...
-- set table ownership
alter table sys_countrycode owner to toledo
;
/*==============================================================*/
/* Index: idx_ccd_id                                            */
/*==============================================================*/
...
-- set table ownership
alter table sys_ip4country owner to toledo
;
/*==============================================================*/
/* Index: idx_i4co_id                                           */
/*==============================================================*/
...
(15018, 2, 'menu_Item_Calendar', 0),f
